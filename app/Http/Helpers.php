    ...
    elseif (get_setting('shipping_type') == 'area_wise_shipping') {
        ...
        if(get_setting('shipping_type') == 'product_wise_shipping') {
            ...
            if($product->is_quantity_multiplied) {
                return  ($city->name == 'Dhaka' ? $product->shipping_cost : $product->shipping_cost_outside) * $cartItem['quantity'];
            } else {
                return $city->name == 'Dhaka' ? $product->shipping_cost : $product->shipping_cost_outside;
            }
