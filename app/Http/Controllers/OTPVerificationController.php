...
class OTPVerificationController extends Controller
{
    ...
    public function verification(Request $request){
        if (Auth::check() && Auth::user()->email_verified_at == null) {
            ...
            flash('Your account is already verified')->warning();
    ...
    public function resend_verificcation_code_seller(Request $request){
        $user = Auth::user();
        $user->verification_code = rand(100000,999999);
        $user->save();
        ...
        flash(translate('Re-send verification code!'))->success();
