...
class BusinessSettingsController extends Controller
{
    ...
    public function update_two (Request $request){
        ...
        $data = WidgetTwo::first();
        $data->widget_two = $request->widget_two;
        $data->widget_two_labels = json_encode($request->widget_two_labels);
        $data->widget_two_links = json_encode($request->widget_two_links);
        $data->update();
