        ...
        <div class="card shadow-none border-0">
            <ul class="list-unstyled mb-3">
                <li class="fw-600 border-bottom pb-2 mb-3">
                    <a class="text-reset" href="{{ route('products.category', \App\Models\Category::find($first_level_id)->slug) }}"> 1234  {{ \App\Models\Category::find($first_level_id)->getTranslation('name') }}</a>
                </li>
