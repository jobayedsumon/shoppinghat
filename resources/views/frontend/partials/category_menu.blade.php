            ...
            <ul class="menu menu-bar">
                <li>
                    ...
                    @foreach (\App\Models\Category::where('level', 0)->orderBy('order_level', 'desc')->get()->take(11) as $key => $category)
                        <li>
                            <a href="javascript:void(0);" class="menu-link mmega-menu-link" aria-haspopup="true">{{ $category->getTranslation('name') }}</a>
                            ...
                            <ul class="menu menu-list">
                                ...
                                <li>
                                    ...
                                    <ul class="menu menu-list">
                                        ...
                                        <li>
                                            <a href="/page" class="menu-link menu-list-link">{{ \App\Models\Category::find($second_level_id)->getTranslation('name') }}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                    @endif
