...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0 h6">{{translate('ELITBUZZ SMS')}}</h3>
                </div>
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'elitbuzz')" @if(\App\Models\OtpConfiguration::where('type', 'elitbuzz')->first() != null && \App\Models\OtpConfiguration::where('type', 'elitbuzz')->first()->value == 1) checked @endif>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
