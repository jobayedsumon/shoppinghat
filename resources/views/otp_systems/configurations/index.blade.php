            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="ELITBUZZ_SENDER_ID">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('ELITBUZZ_SENDER_ID')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="ELITBUZZ_SENDER_ID" value="{{  env('ELITBUZZ_SENDER_ID') }}" placeholder="ELITBUZZ_SENDER_ID" required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
