                    ...
                    <div class="card-body collapse show" id="collapse_2">
                        ...
                        <div class="flat_rate_shipping_div" style="display: none">
                            <div class="form-group row">
                                ...
                                <label class="col-lg-6 col-from-label">{{translate('Shipping cost (Inside Dhaka)')}}</label>
                                <div class="col-lg-6">
                                    <input type="number" lang="en" min="0" value="{{ $product->shipping_cost }}" step="0.01" placeholder="{{ translate('Shipping cost (Inside Dhaka)') }}" name="flat_shipping_cost" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
