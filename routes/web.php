...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user']], function() {
    ...
    Route::get('/shop/phone_verification', 'ShopController@phone_verify')->name('seller.phone.verify');
    Route::post('/shop/phone_verification/success', 'ShopController@phone_verify_success')->name('seller.phone.verify.store');
