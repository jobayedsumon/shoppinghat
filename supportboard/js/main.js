 ...
 * ==========================================================
 *
 * Main Javascript file. This file is shared by frond-end and back-end. © 2017-2021 board.support. All rights reserved.
 * 
 */
            ...
            if (!admin && !loading(element) && !this.is_busy) {
                ...
                switch (type) {
                    case 'email':
                        ...
                        if (success) success = sb_(success).replace('{user_email}', user_settings['email'][0]);
