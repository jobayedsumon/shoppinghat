 ...
 * ==========================================================
 *
 * Ajax functions. This file must be executed only via ajax. © 2017-2021 board.support. All rights reserved.
 *
 */
...
switch ($_POST['function']) {
    ...
    case 'telegram-synchronization':
        die(sb_json_response(sb_telegram_synchronization($_POST['token'])));
    default:
